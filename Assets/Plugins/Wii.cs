...
public class Wii : MonoBehaviour
{
	...
	public static Vector4 GetBalanceBoard(int remote)
    {
        ...
        AppendToReport(
           new string[5]{
                "Patient",currentStates[remote].expFloat5.ToString(),
                currentStates[remote].expFloat6.ToString(),
                currentStates[remote].expFloat7.ToString(),
                currentStates[remote].expFloat8.ToString(),
           }
           );
