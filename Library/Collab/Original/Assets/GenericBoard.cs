...
public class GenericBoard : MonoBehaviour
{
    ...
    {
        Board_Force.x -= Board_Force_error_storage.x;
        Board_Force.y -= Board_Force_error_storage.y;
        Board_Force.z -= Board_Force_error_storage.z;
        Board_Force.w -= Board_Force_error_storage.w;
     }
